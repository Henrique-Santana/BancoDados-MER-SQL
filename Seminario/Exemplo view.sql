...
CREATE VIEW -- NÃO PODE ENTRAR NEM SAIR DADOS DELA, É APENAS UMA VISUALIZAÇÃO.....
vwArtistas AS
SELECT NomeArtista AS Nome,
       IDEstiloMsuical AS IDEstilo
FROM Artistas
...
e  /* Nome do Evento*/
ON SCHEDULE
EVERY 1 MINUTE /* Configura o Intervalo */
DO
INSERT INTO Artistas VALUES (0); /* Declara a ação SQL */
